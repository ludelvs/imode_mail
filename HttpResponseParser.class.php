 ...
 * @category mars
 * @package response
 * @version $Id: Mars_HttpResponseParser.class.php 3112 2011-10-16 19:00:30Z yamakita $
 * @copyright Copyright (c) 2006-2008 Capybara-System corporation
 */

/**
 * Mars_HttpRequestSender から発行したリクエストに対応するレスポンスを解析します。
 * 
 * @author Naomichi Yamakita <yamakita@dtx.co.jp>
 * @category mars
 * @package response
...
class HttpResponseParser
{
   ...
   * @see Mars_HttpResponseParser::getHeader()
   * @since 1.10.0
   * @author Naomichi Yamakita <yamakita@dtx.co.jp>
   */
  ...
  public function getContents($convertEncoding = FALSE)
  {
    ...
    if ($convertEncoding) {
      ...
      $destinationEncoding = default_encoding(ENCODING_TYPE_INTERNAL);
   ...
   * @see Mars_HttpResponseParser::getContents()
   * @since 1.10.0
   * @author Naomichi Yamakita <yamakita@dtx.co.jp>
   */
